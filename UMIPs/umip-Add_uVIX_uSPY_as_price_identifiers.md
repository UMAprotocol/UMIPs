...
---- API
---- Cost to use: Free - End-of-Day Data; Paid – Intraday Data (https://marketstack.com/plan)
--- https://www.tradingview.com/chart/iB9OZdOa/?symbol=CBOE%3AVIX
---- Manual
---- Cost to use: Free
...
---- API
---- Cost to use: Free - End-of-Day Data; Paid – Intraday Data (https://marketstack.com/plan)
--- https://www.tradingview.com/chart/iB9OZdOa/?symbol=AMEX%3ASPY
---- Manual
---- Cost to use: Free
-- Result Processing: None
-- Input Processing: None. 
